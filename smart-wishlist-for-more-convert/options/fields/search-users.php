<?php
/**
 * Template for displaying the search users
 *
 * @author MoreConvert
...
<select id="<?php echo esc_attr( $field_id ); ?>" name="<?php echo '' !== $name ? esc_attr( $name ) . '[]' : ''; ?>" multiple="multiple" class="mc-user-search <?php echo esc_attr( $class ); ?>" data-allow_clear="true" data-minimum_input_length="3"
	data-placeholder="<?php esc_attr_e( 'Search for a user&hellip;', 'mct-options' ); ?>"
