...
if ( ! class_exists( 'WLFMC_Admin' ) ) {
	...
	class WLFMC_Admin {
		 ...
		 * @var string
		 */
		public $rollback_version = '1.9.20';
		...
		public function admin_dashboard_output() {
			...
			$args             = array(
				...
				'marketing_settings' => add_query_arg(
					array(
						'page' => 'mc-global-settings',
						'tab'  => 'marketing',
					),
		...
		public function show_text_settings() {
			...
			<div id="wlfmc_options">
				...
				if ( $this->installed ) {
					$options = new MCT_Options( 'wlfmc_options' );
					$fields  = array(
						'multi_list_under_table',
						'waitlist_under_table',
						...
						'waitlist_required_product_variation',
						'sfl_enable',
						'merge_lists',
						'enable_share',
						'share_position',
						'display_mini_wishlist_for_counter',
						'multi_list_enable_share',
					);
